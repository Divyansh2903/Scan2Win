...
class TextFieldSearchLocal extends StatefulWidget {
  ...
  /// Creates a TextFieldSearchLocal for displaying selected elements and retrieving a selected element
  const TextFieldSearchLocal(
      {Key? key,
      this.initialList,
      required this.label,
  ...
  @override
  State<TextFieldSearchLocal> createState() => _TextFieldSearchState();
}

class _TextFieldSearchState extends State<TextFieldSearchLocal> {
  ...
  Widget build(BuildContext context) {
    return CompositedTransformTarget(
      ...
      child: TextField(
        ...
        decoration: widget.decoration ?? textFieldDecoration,
